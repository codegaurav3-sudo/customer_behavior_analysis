...
-- 1. what is the total revenue by male vs female customers.
...
-- number of previous and show the count of each segment.
...
-- 9. Are customers who are repaet buyers (more then 5 previous purchases) aslo likely to subcribe
SELECT subscription_status, 
